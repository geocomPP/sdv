...
```{r Leeds to Sheffield GPS data, message=FALSE, results='hide', echo=FALSE}
axis(side = 1)
axis(side = 2)
```

In the code above we first used R to *download* a file from the internet !!!!THE CODE DOES NOT MATCH THIS DESCRIPTION!!!!, using the
